...
case class VAlgorithmImplementationDto ( 
   ...
   def fields : String = {    "algorithmImplementationId,guid,insertedRowDate,lastUpdatedDate,algorithmTypeId,algorithmVersionId,executorTypeId,algorithmImplementationName,algorithmImplementationClass,algorithmImplementationDescription,scriptName,scriptParams,algorithmType_algorithmTypeId,algorithmType_guid,algorithmType_insertedRowDate,algorithmType_lastUpdatedDate,algorithmType_algorithmTypeName,algorithmType_algorithmTypeDescription,algorithmVersion_algorithmVersionId,algorithmVersion_insertedRowDate,algorithmVersion_lastUpdatedDate,algorithmVersion_guid,algorithmVersion_algorithmTypeId,algorithmVersion_algorithmVersionName,executorType_executorTypeId,executorType_guid,executorType_insertedRowDate,executorType_lastUpdatedDate,executorType_executorTypeName,executorType_executorTypeClass";    }  
   def pkFields : String = {    "";    }  
   def fkFields : String = {    "";    }  
